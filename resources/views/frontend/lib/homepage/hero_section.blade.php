...
<section class="hero-section">
         ...
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-lg-6 col-md-6">
                  <div class="hero-right">
                     <img src="{{ asset('frontend/assets/img/bannar.png') }}" alt="hero" />
            ...
            <div><a href="{{ url('/contact') }}" class="theme-btn wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">Data Science Summit 2021<span class="fa fa-chevron-right"></span></a></div>
         </div>
</section>
<!-- Hero Section End -->