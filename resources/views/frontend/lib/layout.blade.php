         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 d-flex align-items-center justify-content-between">
                  <div class="logo-area">
                     <a href="{{ url('/') }}"><img src="{{ asset('frontend/assets/img/logo.png') }}" alt="logo" width="100" height="200"></a>
                  </div>
                        ...
                        <nav class="menu-box">
                           <ul class="nav-menu"  id="mobile-menu">
                              ...
                              <li class="dropdown">
                                 ...
                                 <ul>
                                    <li><a href="{{ url('/research-topic') }}">Research Area</a></li>
                                    <li><a href="{{ url('/research-publication') }}">Research Publication</a></li>
                                 </ul>
                              </li>
                              <li><a href="{{ url('/team') }}">Our Team</a></li>
                              <li><a href="{{ url('/curriculum') }}">Our Course Curriculum</a></li>
                              <li><a href="{{ url('/events') }}">Events</a></li>  
                              <li><a href="{{ url('/resources') }}">Resources</a></li> 
                              <li><a href="{{ url('/about') }}">About Us</a></li>  
                              <li><a href="{{ url('/contact') }}">Contact</a></li>
                              <li><a href="{{ url('/summit2021') }}"><button type="button" class="btn btn-warning">Summit 2021</button></a></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
