                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="fas fa-barcode"></i><span class="break"></span>Team Members</h2>
                                <div class="box-icon">
                                ...
                                <table class="table table-hover table-bordered bootstrap-datatable datatable">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-warning">Working Area</th>
                                          <th class="text-warning">Portfolio</th>
                                          <th class="text-warning">Gmail</th>
...
<?php echo $__env->make('backend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DSLab\resources\views/backend/team.blade.php ENDPATH**/ ?>