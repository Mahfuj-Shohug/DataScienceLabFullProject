...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="<?php echo e(URL::asset('frontend/assets/img/logo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('/dashboard/logo')); ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/banner')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Add Banner Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/banner/edit')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-edit"></i>
                  <p>Edit Banner Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/banner/image')); ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/one/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Add About Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/one/edit')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Edit About Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/one/image')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>About Image One</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/two/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Add About Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/two/edit')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Edit About Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/about/two/image')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>About Image One</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/works')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Works</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/works/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Add Works</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/team')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Members</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/team/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Add Member</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/teacher')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Teachers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/teacher/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Add Teacher</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/student')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Students</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/student/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-plus"></i>
                  <p>Add Student</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/research-topic')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Research Topics</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/research-topic/add')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/messages')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>All Messages</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/hackthon')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Hackthon</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/seminar')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Seminar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/dashboard/workshop')); ?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Workshop</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="<?php echo e(url('/')); ?>" target="_blank">Visit Site</a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <script>document.write(new Date().getFullYear())</script>
    Copyright &copy; All Rights Reserved By <a href="<?php echo e(url('https://daffodilvarsity.edu.bd/')); ?>"><strong>Daffodil International University </a></strong>
...
<!-- AdminLTE App -->
<script src="<?php echo e(asset('backend/js/adminlte.js')); ?>"></script>
...
<?php /**PATH H:\Projects\DSLab\resources\views/backend/lib/layout.blade.php ENDPATH**/ ?>