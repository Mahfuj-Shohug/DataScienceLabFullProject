               ...
               <div class="col-lg-8">
                  ...
                  <?php if(Session::has('notify')): ?>
                     <div class="alert alert-success" role="alert">
                        <p class="text-center">
                              <?php echo e(Session::get('notify')); ?> </strong>
                        </p>
                     </div>
                                       
                     <?php echo e(Session::forget('notify')); ?>

                  <?php endif; ?>

                     <form role="form" action="<?php echo e(url('/contact/store')); ?>" method="post" enctype="multipart/form-data">
                     <?php echo csrf_field(); ?>
                        <div class="row">
                           <div class="col-lg-6">
            ...
            <div class="col-lg-4 d-flex">
                <div class="address-area wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                    ...
                    <ul class="address-list">
                        ...
                        <li>
                            <p>
                                <i class="fa fa-phone"></i> +880-1673383289
                            </p>
                        </li>
                        <li>
                            <p>
...
<div class="map-area section_t_100">
    ...
    <iframe
        src="https://maps.google.com/maps?q=Daffodil%20International%20University&t=&z=11&ie=UTF8&iwloc=&output=embed"
        style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DSLab\resources\views/frontend/contact.blade.php ENDPATH**/ ?>