         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 d-flex align-items-center justify-content-between">
                  <div class="logo-area">
                     <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset("storage/$brand->Logo")); ?>" alt="logo" width="100" height="200"></a>
                  </div>
                        ...
                        <nav class="menu-box">
                           <ul class="nav-menu"  id="mobile-menu">
                              ...
                              <li class="dropdown">
                                 ...
                                 <ul>
                                    <li><a href="<?php echo e(url('/research-topic')); ?>">Research Topic</a></li>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="single-footer wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="footer-logo">
                           <a href="index.html"><img src="<?php echo e(asset('frontend/assets/img/logo.png')); ?>" alt="logo" /></a>
                        </div>
...
<?php /**PATH C:\Users\Ashikur Rahaman\OneDrive\Desktop\laravel\DSLab\resources\views/frontend/lib/layout.blade.php ENDPATH**/ ?>