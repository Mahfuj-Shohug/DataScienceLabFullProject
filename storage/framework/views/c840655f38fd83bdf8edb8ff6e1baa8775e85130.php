...
<head>
      ...
      <!-- Favicon -->
      <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('frontend/assets/img/favicon/favicon-32x32.png')); ?>">
      <!--Bootstrap css-->
      ...
      <!-- Flaticon CSS -->
      <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/flaticon/flaticon.css')); ?>">
      <!--Magnific css-->
      ...
      <!-- slicknav cdd -->
      <link rel="stylesheet" href="<?php echo e(asset('frontend/assets/css/slicknav.min.css')); ?>">
      <!--Site Main Style css-->
   ...
   <body>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 d-flex align-items-center justify-content-between">
                  <div class="logo-area">
                     <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('frontend/assets/img/logo.png')); ?>" alt="logo" width="100" height="200"></a>
                  </div>
                        ...
                        <nav class="menu-box">
                           <ul class="nav-menu"  id="mobile-menu">
                              ...
                              <li class="dropdown">
                                 ...
                                 <ul>
                                    <li><a href="<?php echo e(url('/research-topic')); ?>">Research Area</a></li>
                                    <li><a href="<?php echo e(url('/research-publication')); ?>">Research Publication</a></li>
                                 </ul>
                              </li>
                              <li><a href="<?php echo e(url('/team')); ?>">Our Team</a></li>
                              <li><a href="<?php echo e(url('/curriculum')); ?>">Our Course Curriculum</a></li>
                              <li><a href="<?php echo e(url('/events')); ?>">Events</a></li>  
                              <li><a href="<?php echo e(url('/resources')); ?>">Resources</a></li> 
                              <li><a href="<?php echo e(url('/about')); ?>">About Us</a></li>  
                              <li><a href="<?php echo e(url('/contact')); ?>">Contact</a></li>
                              <li><a href="<?php echo e(url('/summit2021')); ?>"><button type="button" class="btn btn-warning">Summit 2021</button></a></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
      ...
      <?php echo $__env->yieldContent('main_content_frontend'); ?>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="single-footer wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="footer-logo">
                           <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('frontend/assets/img/logo.png')); ?>" alt="logo" /></a>
                        </div>
                        ...
                        <ul class="footer-social">
                           <li><a href="https://www.facebook.com/DIUDSL/" class="fb"><i class="fa fa-facebook"></i></a></li>
                           <li><a href="https://daffodilvarsity.edu.bd/" class="fb"><i class="fa fa-globe"></i></a></li>
                           <li><a href="https://www.youtube.com/c/daffodiluniversity" class="fb"><i class="fa fa-youtube"></i></a></li>
                        </ul>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="single-footer wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.6s">
                        ...
                        <ul class="footer-contact-info">
                           <li>Daffodil Smart City, Ashulia, Dhaka</li>
                           <li><span>Email:</span> <a href="mailto:hello@example.com">arman.swe@diu.edu.bd</a></li>
                           <li><span>Phone:</span> <a href="tel:+44587154756">+880-1673383289</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="copyright wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        <p>&copy; 2021 All Rights Reserved By <span> <a href="https://daffodilvarsity.edu.bd/department/swe" target="_blank">Daffodil International University</a> </p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!-- Slicknav Js -->
      <script src="<?php echo e(asset('frontend/assets/js/jquery.slicknav.min.js')); ?>"></script>
      <!--Magnific js-->
...
<?php /**PATH H:\Projects\DSLab\resources\views/frontend/lib/layout.blade.php ENDPATH**/ ?>