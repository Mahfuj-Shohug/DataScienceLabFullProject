                     ...
                     <div class="blog-item-box">
                        <div class="blog_info">
                           <figure class="blog-img">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/blog-2.jpg')); ?>" alt="blog imag">
                              </a>
                           </figure>
                    ...
                    <div class="map-area section_t_100">
                     ...
                     <div class="blog-item-box">
                        <div class="blog_info">
                           <figure class="blog-img">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/blog-1.jpg')); ?>" alt="blog imag">
                              </a>
                           </figure>
                           <div class="blog-detail">
                    ...
                    <div class="map-area section_t_100">
                     ...
                     <div class="blog-item-box">
                        <div class="blog_info">
                           <figure class="blog-img">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/blog-3.jpg')); ?>" alt="blog imag">
                              </a>
                           </figure>
                           <div class="blog-detail">
                              <h3><a href="#">Get Free datasets Available There</a></h3>
...
<?php echo $__env->make('frontend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ashikur Rahaman\OneDrive\Desktop\laravel\DSLab\resources\views/frontend/resources.blade.php ENDPATH**/ ?>