                     ...
                     <div class="row align-items-center">
                        <div class="col-lg-4 offset-lg-1">
                           <figure class="blog-img about-page-left wow fadeInLeft mr-5" data-wow-duration="1s" data-wow-delay="0.5s">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/area-1.jpg')); ?>" alt="Image" />
                              </a>
                           </figure>
                        </div>
                        <div class="col-lg-6">
                  ...
                  <div class="row align-items-center">
                     <div class="row align-items-center">
                        <div class="col-lg-4 offset-lg-1">
                           <figure class="blog-img about-page-left wow fadeInLeft mr-5" data-wow-duration="1s" data-wow-delay="0.5s">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/area-2.jpg')); ?>" alt="Image" />
                              </a>
                           </figure>
                        </div>
                        <div class="col-lg-6">
                  ...
                  <div class="row align-items-center">
                     <div class="row align-items-center">
                        <div class="col-lg-4 offset-lg-1">
                           <figure class="blog-img about-page-left wow fadeInLeft mr-5" data-wow-duration="1s" data-wow-delay="0.5s">
                              <a href="#">
                              <img src="<?php echo e(asset('frontend/assets/img/area-3.png')); ?>" alt="Image" />
                              </a>
                           </figure>
                        </div>
                        <div class="col-lg-6">
...
<?php echo $__env->make('frontend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DSLab\resources\views/frontend/research_topic.blade.php ENDPATH**/ ?>