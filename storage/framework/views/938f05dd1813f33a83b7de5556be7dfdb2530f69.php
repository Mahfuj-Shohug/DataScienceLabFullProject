...
<section class="about-section">
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="about-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <img src="<?php echo e(asset("storage/$about_one_image->home_about_one_image")); ?>" alt="about" />
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="about-right wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        <img src="<?php echo e(asset("storage/$about_two_image->home_about_two_image")); ?>" alt="about" />
                     </div>
                  </div>
                  <div class="col-lg-6">
   ...
   <!-- About Section End --><?php /**PATH C:\Users\Ashikur Rahaman\OneDrive\Desktop\laravel\DSLab\resources\views/frontend/lib/homepage/about_section.blade.php ENDPATH**/ ?>