                                ...
                                <table class="table table-hover table-bordered bootstrap-datatable datatable">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-warning">Workshop Name</th>
                                  ...
                                  <tbody>
                                      ...
                                      <?php $__currentLoopData = $workshop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                            <td> <?php echo e($c->name); ?></td>
                                            <td class="center"><?php echo e($c->varsity); ?></td>
                                            <td class="center"><?php echo e($c->dept); ?></td>
                                            <td class="center"><?php echo e($c->wname); ?></td>
...
<?php echo $__env->make('backend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Projects\DSLab\resources\views/backend/workshop.blade.php ENDPATH**/ ?>