               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="about-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
                        <img src="<?php echo e(asset('frontend/assets/img/about.png')); ?>" alt="about" />
                     </div>
                  </div>
                  <div class="col-lg-6">
                  ...
                  <div class="row align-items-center">
                     <div class="col-lg-6">
                        <div class="about-right wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                           <img src="<?php echo e(asset('frontend/assets/img/about.jpg')); ?>" alt="about" />
                        </div>
                     </div>
                     <div class="col-lg-6">
...
<?php echo $__env->make('frontend.lib.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ashikur Rahaman\OneDrive\Desktop\laravel\DSLab\resources\views/frontend/about.blade.php ENDPATH**/ ?>